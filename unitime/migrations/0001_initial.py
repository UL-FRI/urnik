...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='AcademicArea',
            fields=[
                ('uniqueid', models.DecimalField(decimal_places=0, max_digits=20, primary_key=True, serialize=False)),
                ('academic_area_abbreviation', models.CharField(blank=True, max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('uniqueid', models.DecimalField(decimal_places=0, max_digits=20, primary_key=True, serialize=False)),
                ('owner_id', models.DecimalField(blank=True, decimal_places=0, max_digits=20, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('obj_uid', models.DecimalField(blank=True, decimal_places=0, max_digits=20, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('managing_dept', models.DecimalField(blank=True, decimal_places=0, max_digits=20, null=True)),
                ...
                ('last_modified_time', models.DateTimeField(blank=True, null=True)),
                ('uid_rolled_fwd_from', models.DecimalField(blank=True, decimal_places=0, max_digits=20, null=True)),
                ('external_uid', models.CharField(blank=True, max_length=40)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('uniqueid', models.DecimalField(decimal_places=0, max_digits=20, primary_key=True, serialize=False)),
                ('session_id', models.DecimalField(blank=True, decimal_places=0, max_digits=20, null=True)),
                ('external_uid', models.CharField(blank=True, max_length=40)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('abbreviation', models.CharField(blank=True, max_length=10)),
                ('legacy_crse_master_code', models.CharField(blank=True, max_length=10)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('uniqueid', models.DecimalField(decimal_places=0, max_digits=20, primary_key=True, serialize=False)),
                ('credit_format', models.CharField(blank=True, max_length=20)),
                ('credit_unit_type', models.DecimalField(blank=True, decimal_places=0, max_digits=20, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('demand_offering_type', models.DecimalField(blank=True, decimal_places=0, max_digits=20, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pref_group_id', models.DecimalField(blank=True, decimal_places=0, max_digits=20, null=True)),
                ('last_modified_time', models.DateTimeField(blank=True, null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sponsoring_org', models.DecimalField(blank=True, decimal_places=0, max_digits=20, null=True)),
        ...
        migrations.CreateModel(
            name='HashedQueries',
            fields=[
                ('query_hash', models.CharField(max_length=48, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('next_hi', models.DecimalField(blank=True, decimal_places=0, max_digits=20, null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('location_perm_id', models.DecimalField(blank=True, decimal_places=0, max_digits=20, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('uniqueid', models.DecimalField(decimal_places=0, max_digits=20, primary_key=True, serialize=False)),
                ('room_id', models.DecimalField(blank=True, decimal_places=0, max_digits=20, null=True)),
                ('is_control', models.IntegerField(blank=True, null=True)),
            ],
            options={
                'db_table': 'room_dept',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('uniqueid', models.DecimalField(blank=True, decimal_places=0, max_digits=20, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('uniqueid', models.DecimalField(decimal_places=0, max_digits=20, primary_key=True, serialize=False)),
                ('student_id', models.DecimalField(blank=True, decimal_places=0, max_digits=20, null=True)),
                ('last_modified_time', models.DateTimeField(blank=True, null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('uniqueid', models.DecimalField(decimal_places=0, max_digits=20, primary_key=True, serialize=False)),
                ('session_id', models.DecimalField(blank=True, decimal_places=0, max_digits=20, null=True)),
                ('subject_area_abbreviation', models.CharField(blank=True, max_length=10)),
                ('long_title', models.CharField(blank=True, max_length=100)),
                ('external_uid', models.CharField(blank=True, max_length=40)),
                ('last_modified_time', models.DateTimeField(blank=True, null=True)),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('uniqueid', models.DecimalField(decimal_places=0, max_digits=20, primary_key=True, serialize=False)),
                ('external_uid', models.CharField(blank=True, max_length=40, unique=True)),
                ('first_name', models.CharField(blank=True, max_length=100)),
                ('middle_name', models.CharField(blank=True, max_length=100)),
                ('last_name', models.CharField(blank=True, max_length=100)),
